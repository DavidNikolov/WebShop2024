    ...
    public class ProductController : Controller
    {
        ...
        public ActionResult Create([FromForm] ProductCreateVM product)
        {
            if (ModelState.IsValid)
            {
                ...
                if (createdId) return RedirectToAction(nameof(Index));
            }
        ...
        public ActionResult Edit(int id)
        {
            ...
            updateProduct.Brands = _brandService.GetBrands().Select(x => new BrandPairVM()
            {
                Id = x.Id,
                Name = x.BrandName
            }).ToList();

            updateProduct.Categories = _categoryService.GetCategories().Select(x => new CategoryPairVM()
            {
                Id = x.Id,
                Name = x.CategoryName
            }).ToList();
        ...
        public ActionResult Delete(int id, IFormCollection collection)
        {
            ...
            if (deleted) return this.RedirectToAction("Success");
            else return View();
        }
